        ...
        <section id="achievements" className="py-24 relative overflow-visible">
            ...
            {summary ? (
                <div className="mt-20 flex justify-center pb-8 border-none">
                    <Link to="/achievements" className="group relative px-12 py-6 rounded-[2rem] bg-[#0a0a0a]/50 backdrop-blur-xl border border-white/5 hover:border-violet-500/30 transition-all duration-500 overflow-hidden shadow-2xl">
                        {/* Hover Aurora Effect */}
