...
import { Calendar, Briefcase, Building2, ChevronRight, ArrowRight } from 'lucide-react';
            ...
            >
                ...
                <div className="max-w-5xl mx-auto pl-4 md:pl-0">
                    <div className="relative">
                        ...
                        <div className="space-y-20 md:space-y-32 pb-6 md:pb-12">
                    ...
                    {summary && (
                        <div className="mt-8 flex justify-center pb-8 relative z-40 bg-transparent">
                            <Link to="/experience" className="group relative px-12 py-6 rounded-[2rem] bg-[#0a0a0a]/50 backdrop-blur-xl border border-white/5 hover:border-violet-500/30 transition-all duration-500 overflow-hidden shadow-2xl">
                                {/* Hover Aurora Effect */}
